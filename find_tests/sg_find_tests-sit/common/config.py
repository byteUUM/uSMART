...
STOCK_LIMIT_ORDER_ID = 1610005879714152448    # 股票限价单, 委托价敏感性用例使用
STOCK_ORDER_ID = 0                            # 待补: 股票在途单(原订单已不在途)
OPTION_SHORT_ORDER_ID = 1608213092622376961   # 期权沽空在途单
COMBO_ORDER_ID = 1608200135293247489          # 组合期权在途单
SHORT_ORDER_ID = 0                            # 待补: 当前 token 用户的股票沽空在途单
